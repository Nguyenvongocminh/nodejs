...
export type renderImageHandler = (
...
export interface RenderImageProps<CustomPhotoProps extends object = {}> {
  ...
  onClick: renderImageHandler | null
  onMouseEnter: renderImageHandler | null
  onMouseLeave: renderImageHandler | null
  direction: 'row' | 'column'
  top?: number
  left?: number
}

export type PhotoHandler<CustomPhotoProps extends object = {}> = (
  event: React.MouseEvent,
  photos: {
    index: number
...
export interface GalleryProps<CustomPhotoProps extends object = {}> {
   ...
   */
  onClick?: PhotoHandler<CustomPhotoProps>
  onMouseEnter?: PhotoHandler<CustomPhotoProps>
  onMouseLeave?: PhotoHandler<CustomPhotoProps>
